...
public class InfinityFluidStorageCellInventory implements ITFluidCellInventory {
    ...
    protected ItemInfinityStorageFluidCell cellType;
    ...
    public InfinityFluidStorageCellInventory(ItemStack o, ISaveProvider c, EntityPlayer player) throws AppEngException {
        ...
        this.cellItem = o;
        this.cellType = (ItemInfinityStorageFluidCell) this.cellItem.getItem();
        this.container = c;
    ...
    private void saveChanges() {
        this.data.setBoolean(InfinityCellConstants.IS_EMPTY, this.cellFluids.isEmpty());
