...
public final class NekoWidgetThemes {
    ...
    // ID 加 neko_ 前缀：避免与 VM mod 的 WidgetThemes 注册的同名 ID 冲突，
    // 否则 ThemeAPI.registerWidgetTheme 会因 ID 重复抛 IllegalStateException，
    // 导致 ExceptionInInitializerError 崩溃。
    public static final WidgetThemeKey<WidgetTheme> BACKGROUND_SIDEPANEL = themeApi
        .widgetThemeKeyBuilder("neko_background_side_panel", WidgetTheme.class)
        .defaultTheme(
    ...
    public static final WidgetThemeKey<TextFieldTheme> BACKGROUND_SEARCH_BAR = themeApi
        .widgetThemeKeyBuilder("neko_background_search_bar", TextFieldTheme.class)
        .defaultTheme(
            new TextFieldTheme(
                0,
                0,
    ...
    public static final WidgetThemeKey<WidgetTheme> THEME_TRADE_BUTTON = themeApi
        .widgetThemeKeyBuilder("neko_background_tile_trade_button", WidgetTheme.class)
